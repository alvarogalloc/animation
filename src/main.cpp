...
int main()
{
  ...
  core::game()
    .add_setup_callback(std::bind_front(&core::physics::system::startup, &physics_system))
    ...
    .add_update_callback(std::bind_front(&core::physics::system::update, &physics_system))
    .add_update_callback(core::systems::update_animations)
    .add_update_callback(std::bind_front(&core::render::system::update, &render_system))
